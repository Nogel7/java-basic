...
public class WhileQ2 {
	...
	public static void main(String[] args) {
		...
		// for문 같은 경우 위 3개 요소를 한줄에 담는다면
		// while은 따로 떨어뜨려 두는 것이 특징입니다.
		// 따라서 한 줄에 있냐, 떨어져 있냐만 뺴면 사실상 같은 구문입니다.
		
		// i while문 변수 생성
	    // 구구단 이므로 시작값 2
		// i while문의 조건식 생성(범위 2~9를 갖게하기 위해 10이 되면 false가 되도록 설계)
		
		// j while문 변수 생성
		//i가 x단 이므로, j는 1부터 시작합니다.
		// j while문의 조건식 생성(범위 1~9를 가지게 합니다.)
		// for문은 다 돌고나서 i값을 증가시키기 때문에 우선 아래쪽에 둡니다.
		// i = i + 1; // i += 1; 셋 중 하나를 기입해서
		// i값을 증가시킵니다.
